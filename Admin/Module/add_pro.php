...
if(isset($_POST['submit']))
{
	...
	move_uploaded_file($_FILES['img']['tmp_name'],"../images/".$photo);	
	$sub="INSERT INTO `shopping`.`product` (`name`, `category`, `price`, `quantity`, `for_whom`, `color`, `discount`, `Scharge`, `image`) VALUES ('$name','$category','$price','$quantity','$for','$color','$dis', '$ship','$photo')";
	mysql_query($sub,$con);
