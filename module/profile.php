...
$select="SELECT * FROM  `sold_product` WHERE  `user_id` =$iid ORDER BY `b_date` DESC";
	...
	while($r=mysql_fetch_array($sec))
	{
        ...
        <tr >
        		<td width="100px" align="center"> <?php echo ++$count; ?> </td>
        		<td><br /><a target="new" href="Admin/images/<?php echo $pp['image'] ?>"><img src="Admin/images/<?php echo $pp['image'] ?>" height="200px" width="200px" /></a><br />
