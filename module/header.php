...
<link rel="icon" href="images/head_icon.jpg" type="text/css">
<style>
body {
        	...
        	<div class="call">
                ...
                <?php
						...
						$r=mysql_fetch_array($res);
							...
							?><b>Need help?</b> call us <font color="#EE0000">1-22-3456789</font><?php
		...
		<div class="header_top">
			<div class="logo">
			  ...
			  <div style="float:right; margin-top:-25px">
			  	   <a href="index.php?page=wishlist"><img src="images/p1.jpeg"></a>
                   <a href="index.php?page=cart"><img src="images/pw.jpeg"></a>
			  </div>
	...
	<div class="header_bottom">
	     	<div class="menu">
	     		<ul>
			    	...
			    	<li><a href="index.php?page=delevary">Delivery</a></li>
