    ...
    <div class="content">
    	...
    	<div class="section group">
				...
				<div class="desc span_3_of_2">
					...
					<p>It's All for you.<br />
                    </p><p><font color="#FF0000">
                    <?php 
					if($s['quantity']>0)
					{
						?>only <?php echo $s['quantity']; ?> left</font></p>
       				<?php    
                    }	
					else
					{
        ...
        <?php if($s['quantity']<=0)
					{
						echo "Out of stock"; ?> left</font></p>
       				<?php    
                    }	
					else
					{
						echo "Please login to add to card or wishlist";
					}
					?>
        		</font>
                 <?php } ?>
